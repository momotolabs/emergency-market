...
return [
     ...
     */
    'event_class_map' => [
        'resource_created' => \App\StorableEvents\PricingResourceCreated::class,
        'resource_updated' => \App\StorableEvents\PricingResourceUpdated::class,
        'parking_created' => \App\StorableEvents\ParkingDeployCreated::class,
        'parking_updated' => \App\StorableEvents\ParkingDeployChanged::class,
    ],
